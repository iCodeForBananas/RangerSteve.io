...
export default function ControlsView({ game, onKeyboardControlChange, onSetResetEventsFlag }) {
  ...
  function handleSetAzerty() {
    ...
    localStorage.setItem("keyboardControl.left", window.Phaser.Keyboard.Q);
    onKeyboardControlChange(obj);

    obj["right"] = window.Phaser.Keyboard.D;
    localStorage.setItem("keyboardControl.right", window.Phaser.Keyboard.D);
    onKeyboardControlChange(obj);

    obj["up"] = window.Phaser.Keyboard.Z;
    localStorage.setItem("keyboardControl.up", window.Phaser.Keyboard.Z);
    onKeyboardControlChange(obj);

    obj["switchWeapon"] = window.Phaser.Keyboard.A;
    localStorage.setItem("keyboardControl.switchWeapon", window.Phaser.Keyboard.A);
    onKeyboardControlChange(obj);

    obj["newChatMessage"] = window.Phaser.Keyboard.T;
    localStorage.setItem("keyboardControl.newChatMessage", window.Phaser.Keyboard.T);
    onKeyboardControlChange(obj);
  ...
  function handleSetQwerty() {
    ...
    localStorage.setItem("keyboardControl.left", window.Phaser.Keyboard.A);
    onKeyboardControlChange(obj);
    ...
    localStorage.setItem("keyboardControl.up", window.Phaser.Keyboard.W);
    onKeyboardControlChange(obj);

    obj["switchWeapon"] = window.Phaser.Keyboard.Q;
    localStorage.setItem("keyboardControl.switchWeapon", window.Phaser.Keyboard.Q);
    onKeyboardControlChange(obj);
